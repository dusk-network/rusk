...
type NetworkStoreServices = {
  connect: () => Promise<import("$lib/../../../w3sper.js/src/mod").Network>;
  disconnect: () => Promise<void>;
  getAddressSyncer: (
    options?: NetworkSyncerOptions
  ) => Promise<import("$lib/../../../w3sper.js/src/mod").AddressSyncer>;
...
type WalletStoreContent = {
  ...
  currentProfile: import("$lib/../../../w3sper.js/src/mod").Profile | null;
  initialized: boolean;
  addresses: string[];
  profiles: Array<import("$lib/../../../w3sper.js/src/mod").Profile>;
};
...
type WalletStoreServices = {
  ...
  clearLocalDataAndInit: (
    profileGenerator: import("$lib/../../../w3sper.js/src/mod").ProfileGenerator,
