...
/**
 * // TODO possibly a circular dependency case during tests
 *
...
/** @type {(profiles: Array<import("$lib/../../../w3sper.js/src/mod").Profile>) => string[]} */
...
class WalletCache {
   ...
   * @param {Array<import("$lib/../../../w3sper.js/src/mod").Profile>} profiles
