...
#cargo r --release -p dusk-rusk -- recovery state --init rusk-recovery/config/mainnet.toml -o /tmp/mainnet.state
...
RUSK_EXT_CHAIN=$TEMP_DIR DUSK_CONSENSUS_KEYS_PASS=password cargo r --release -p dusk-rusk -- -s /tmp/mainnet.state --config rusk/mainnet.config.toml
